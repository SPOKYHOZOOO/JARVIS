...
def wish():
    ...
    if hour >= 20 and hour <= 24:
        a.speak("SELAMAT MALAM TUAN HOZOO")
    elif hour >= 2 and hour <=12:
        a.speak("SELAMAT PAGI TUAN HOZOO")
    elif hour>12 and hour<4:
        a.speak("SELAMAT DATANG DI TERMUX TUAN HOZOO")
    else:
        a.speak("TUAN HOZOO APAKAH BISA BANTU ?")
    a.speak("TUAN")
    ...
    def run_jarvis():
        ...
        if 'wikipedia' in query:
            ...
            if zoom_counter < 1:
                ...
                a.speak("TUAN HOZOO APA ANDA BISA DI BANTU ")
                response = command().lower()
